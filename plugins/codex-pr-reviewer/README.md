...
A review still running is left alone entirely: its worktree, branches, and
shared clone are held back and named, rather than deleted from under a paid run
whose output has not been written yet.
