...
const USAGE =
  "usage: setup-control.mjs catalog|summary|providers|guide add|models <provider-id>|efforts <provider-id> <api|oauth> <model>|save|apply [--dry-run]|menu|menu-command";
