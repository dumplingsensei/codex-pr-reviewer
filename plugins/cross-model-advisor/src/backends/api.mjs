 ...
 * OAuth or calls a provider.
 *
 * @param {{ provider: unknown, advisor: unknown, env?: NodeJS.ProcessEnv | Record<string, string | undefined> }} args
 * @returns {Promise<{ available: boolean, error?: { code: ApiErrorCode, message: string } }>}
 */
export async function validateApi({ provider, advisor, env = process.env }) {
