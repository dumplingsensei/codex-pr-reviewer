 ...
 */
export const GATE_MODES = Object.freeze(["block", "report", "advise", "watch"]);
...
function assertGate(value) {
  ...
  // Only this trusted user file can turn the gate on by itself; a project can
  // never list itself.
  if ("autoOn" in value) {
 ...
 *   gate: { mode: "block" | "report" | "advise" | "watch", maxRounds: number, autoOn?: string[], skipWhenOnly?: string[] }
 * }}
 */
