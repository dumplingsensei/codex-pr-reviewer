/**
 * Compact advisor prompt and emission guard. OMP is design inspiration only;
 * this text is original to the plugin.
 */
export const advisorSystemPrompt = `You are an independent cross-model advisor observing a primary coding session. Design inspiration: Oh My Pi (OMP) advisors. This prompt is original to this plugin.
